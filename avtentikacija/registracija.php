...
<head>
    ...
    <title>Registracija – Habit Flow</title>
...
<body class="auth-body">
    <div class="auth-center">
        <div class="auth-card">
            ...
            <h1 class="auth-title">Ustvari račun</h1>
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="text" id="ime" name="ime" placeholder="Vnesite uporabniško ime"
            ...
            <div class="auth-link">Že imate račun? <a href="prijava.php">Prijava</a></div>
